...
var sliderSettings = {}, nav = {}, in5 = {layouts:[
 	{
 		...
 		"height": 841.8897637795,
 		"default": true,
 		"trigger": "default",
 		"index": 0
 	}
 ]},
viewOpts = {"title":1,"page":1,"zoom":1,"fs":1,"pdf":0,"toc":189,"thumbs":1,"progress":0,"showbar":1,"bg":"#00634f","footer":0};
...
function addNavProps(){
	if(nav.numPages === undefined) nav.numPages=194;
